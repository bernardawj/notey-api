...
public interface ProjectRepository extends PagingAndSortingRepository<Project, Integer> {
    ...
    Page<Project> findProjectsByManagerId(@Param("managerId") Integer managerId, @Param("filter") String filter, Pageable pageable);
    ...
    Page<Project> findProjectsByUserId(@Param("userId") Integer userId, @Param("filter") String filter, Pageable pageable);
